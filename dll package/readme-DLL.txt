...
INSTALLING Qtpfsgui
===================
The zip file contains all the DLLs required by the Windows version of Qtpfsgui.

Unzip this file in the folder where you have the ``qtpfsgui.exe'' file.

Make sure you enable the "use folder names" option to unzip the archive.

For example, if you have the following layout:

C:\qtpfsgui\qtpfsgui.exe

You need to unzip the files in the ``c:\qtpfsgui'' folder. The result will be:
...
Giuseppe Rota
grota "at" users.sourceforge "dot" net
